...
public class RewardAdapter extends ArrayAdapter<Reward> {
    ...
    public RewardAdapter(Context context, int textViewResourceId, List<Reward> objects){
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        Reward reward = getItem(position);//获取当前项的Follow实例
        View view;
        ...
        viewHolder.commentHeader.setImageResource(reward.getHeader());
        viewHolder.commentImage.setImageResource(reward.getImage());
        viewHolder.commentName.setText(reward.getName());
        viewHolder.commentTitle.setText(reward.getTitle());
        viewHolder.commentIntro.setText(reward.getIntro());
